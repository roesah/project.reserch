...
<body>
    <div class="image-container">
        <img src="images/le1.png" alt="Example Image">

        <div class="button-container">
            @foreach ($lessons as $lesson)
            @if ($lesson->Chapters === '1')
            <a class="button button1">ข้อที่ 1</a>
            <a class="button button2">ข้อที่ 2</a>
            <a class="button button3" href="exercise.level1">ข้อที่ 3</a>
            @endif
            @endforeach
        </div>
    ...
    <footer>
        <div class="image-containerme">
            ...
            <a href="lesson.level1">
                <img src="images/re1.png" alt="">
            </a>
            <a href="dashboard">
                <img src="images/bh.png" alt="">
            </a>
        </div>
        <style>
